...
class WsabieClassifier(Classifier):
    def train(self, X, y, lemmapos_list):
        ...
        # FIT
        self.clf = self.clf.fit(interactions = y_interactionLabels, user_features = X_CSR, item_features = None, sample_weight = None, epochs = self.num_epochs, num_threads = 10, verbose = True)
